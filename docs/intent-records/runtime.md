...
The public command is `antonina`. Its public namespaces are exactly `antonina agent ...` for managed-agent operations and `antonina board ...` for Borys operations. Direct agent commands and alternate compatibility launchers are not part of the product contract.
